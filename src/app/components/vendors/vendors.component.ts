...
export class VendorsComponent implements OnInit {
  ...
  locations:any[] = [];
  plans:any[] = [];
  displayedColumns: string[] = ['id','logo','email','phone','companyname', 'registereddate', 'membership','profilestatus','verificationstatus','membershipdetails','toggleactivestatus'];
  vendors:any[] = [];
  constructor(
